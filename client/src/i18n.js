const cs = {
  ...
  settings: {
    ...
    notifications_desync: 'Toto zařízení není u serveru registrované — notifikace by nedorazily.',
    notifications_reconnect: 'Znovu propojit',
    notifications_last_delivery: 'Naposledy doručeno: {when}',
    notifications_never_delivered: 'Zatím nic nedoručeno.',
    notifications_last_error: 'Poslední pokus selhal: {err}',
