...
## 3. Kanonická taxonomie (24 kategorií)
...
| 14 | Licence | 2 | roční 72000 (6000×12) |
...
| 19 | Y - Pojistky | 2 | roční 7200 (600×12) |
| 20 | Drahé věci | 1 | 0 |
| 21 | Ostatní | 1 | — (fallback) |
| 22 | Příjmy | 1 | — (vyloučena z výdajových budgetů; je příjem) |
| 23 | Převody | 1 | — (vyloučena z budgetů i z příjmů) |
| 24 | Pravidelné platby | 1 | — (bez budgetu = mimo měsíční budgety; dočasný domov pro AB „Pravidelne mesicni", než vznikne tracker) |

Změny oproti původní sadě 22: zrušeno **Lékárna** (drobné → Jídlo, dražší zdraví →
Y-Léky/PrEP); **Pojistky** (t1) → **Y - Pojistky** (t2, roční 7200);
**Beach a Tom cvíčo** (t1) → **Y - Tom cvíčo** (t2); **Y - Auto Moto - Servis**
t1→t2; **Licence** t1→t2 (roční 72000); přidáno **Příjmy**, **Převody**,
**Pravidelné platby**.

**Sladění `fixed_expenses` vs taxonomie:** „Y - Pojistky 600" má nyní odpovídající
roční kategorii (drift vyřešen). „Y - Beach a cvíčo 3800" zůstává verbatim jako
měsíční rezerva; kosmeticky neodpovídá „Y - Tom cvíčo" – rezervy jsou nezávislé na
kategoriích (jen název+částka), ponecháno beze změny.
...
Pravidelne mesicni                              → Pravidelné platby (mimo budget)
Pojištění                                       → Y - Pojistky
Sociální, Splátky, Výběr hotovosti,
...
3. **Verifikace:** počty (categories=24, accounts=10, transactions≈1012, fixed=8,
...
- **annual.js** – annual_budgets: Y - Léky, PrEP, Optika 20000 (přesun z Lékárny),
  Y - Auto Moto - Servis 30000, Y - Tom cvíčo 33000, Y - Pojistky 7200 (600×12),
  Licence 72000 (6000×12). budget_items: Lítačka Tom 3650
...
- **Tracker pravidelných plateb:** samostatná sekce zobrazující každou pravidelnou
  ...
  → kategorie „Pravidelné platby" (bez budgetu).
...
- **Drift názvů fixed_expenses vs taxonomie:** vyřešeno pro Pojistky (nová roční
  kategorie); „Y - Beach a cvíčo" ponecháno verbatim (kosmetické, rezerva nezávislá
  na kategorii).
