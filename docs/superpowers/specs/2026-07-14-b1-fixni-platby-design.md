...
existujícím. Úpravu seznamu (přejmenování Stodůlky→Stodola, přidání Buřinka 1+2/
Splátka AirBank/Nájem rezerva) provede uživatel ručně na nové stránce po
nasazení. **T-Mobile a Nordic (internet) zůstávají jako fixní platby** – nemažou
se, migrace jim jen dopočítá rozmezí.
